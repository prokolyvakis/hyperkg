...
extern "C"
void testHead(REAL *con, INT show=1) {
...
#ifdef EQUALITY
            if ( (value < minimal) || compareREALs(value, minimal) ) {
#else
            if (value < minimal) {
#endif
                l_s += 1;
...
extern "C"
void testTail(REAL *con, INT show=1) {
